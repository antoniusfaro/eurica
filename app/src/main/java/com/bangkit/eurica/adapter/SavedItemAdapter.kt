...
import com.bangkit.eurica.ui.saved.DetailSavedActivity
import com.bangkit.eurica.ui.scan.DetailItemActivity

class SavedItemAdapter(
    private val context: Context,
    private val dataset: List<SavedList>,
    private val moneyName: String?,
) : RecyclerView.Adapter<SavedItemAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.imageView.setOnClickListener{
            ...
            val intent = Intent(context, DetailSavedActivity::class.java)
//
            intent.putExtra(DetailItemActivity.EXTRA_ITEM_NAME, item.name)
            intent.putExtra(DetailItemActivity.EXTRA_ITEM_PRICE, item.item_price)
            if (moneyAmount != null) {
